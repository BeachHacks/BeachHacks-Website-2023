    ...
    <section className='sponsor-view' id='sponsors'>
      ...
      <div className='sponsor'>
          ...
          <div className='top'>
            ...
            <div className='container medium-sponsor'>
              <a href='https://www.csulb.edu/college-of-engineering'>
                <img src='https://www.csulb.edu/sites/default/files/images/2line.name_.coe_.png'
                     alt='CSULB College of Engineering' />
              </a>
            </div>
            <div className=' medium-sponsor'>
              <a href='https://www.bisecthosting.com/'>
                <img src={'https://i.imgur.com/jzYw45G.png'} alt='Bisect Hosting Goes Here' />
              </a>
            </div>
            <div className='container medium-sponsor'>
        ...
        <div className='right'>
          ...
          <a href='https://drive.google.com/file/d/1l3p-3Cju9sHnrNiguq4Uylv80qgGqvFM/view' target='_blank'
             rel='noreferrer'>
